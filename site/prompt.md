...
2. Ask me which of these I want:
   ...
   c. PREFLIGHT — my code has no tests: build a measured-strength characterization oracle first
   ...
   If I'm not sure, propose (b) on my smallest pure dependency and estimate the time before starting.
